...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] is None and people[person]["father"] is None:
            #if no parents use conditional prob
            gene_prob = PROBS["gene"][gene_count]
        else:
            #based on parents
            mother = people[person]["mother"]
            father = people[person]["father"]
            # chance of passing the gene
            def pass_gene_prob(parent):
            ...
            #chances of inhereting genes
            mother_prob = pass_gene_prob(mother)
            father_prob = pass_gene_prob(father)
            if gene_count == 2:
